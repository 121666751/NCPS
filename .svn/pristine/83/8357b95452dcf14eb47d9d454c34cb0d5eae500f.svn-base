...
public class RsaCertUtils {
	...
	public static PrivateKey getPriKeyPkcs12(String keyfile, String keypwd, String type) {
		...
		try {
			...
			if (aliasenum.hasMoreElements()) {
				// 第一个条目
				keyAlias = "gxnxncp";//(String) aliasenum.nextElement();
			}
	...
	public static PrivateKey getPriKeyPkcs12(String keyfile, String keypwd, String type, String _keyAlias) {
		KeyStore keyStore = getKeyStore(keyfile, keypwd, type);
		PrivateKey privateKey = null;
		try {
			Enumeration<String> aliasenum = keyStore.aliases();
...
//			}
	...
	public static PrivateKey getPriKeyJks(String keyfile, String keypwd, String type, String _keyAlias) {
		return getPriKeyPkcs12(keyfile, keypwd, type, _keyAlias);
	}
