...
//      System.out.println("结果："+changeY2F("1.00000000001E10"));  
    	 System.out.println(AmountUtils.changeY2F("100"));  
        System.out.println(AmountUtils.changeY2F("1.33"));  
        System.out.println(AmountUtils.changeY2F("1.3"));
        System.out.println(AmountUtils.changeY2F("0.03"));
        try {
			System.out.println(AmountUtils.changeF2Y("13301"));
			System.out.println(AmountUtils.changeY2F("13300"));
		} catch (Exception e) {
			e.printStackTrace();
		}
